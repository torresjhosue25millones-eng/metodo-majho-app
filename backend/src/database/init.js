...
function seed() {
  const modules = [
    { id: 1, title: 'Tu Embarazo Sagrado', subtitle: 'El portal de una nueva alma', description: 'El embarazo es una de las experiencias más sagradas del universo. Tu cuerpo es el templo por donde llega un alma a esta dimensión. Aprende a vivir cada etapa con consciencia, amor y espiritualidad profunda.', age_range: 'embarazo', age_label: 'Embarazo', color: '#E8C8CC', icon: '🤰', order_num: 1, lessons_count: 5, audiobook_url: null },
    { id: 2, title: 'Tu Bebé Canal de Abundancia', subtitle: '0 a 2 años · El amor hecho cuerpo', description: 'Tu bebé llegó como un canal puro de amor divino. Estos primeros años son los más sagrados para el vínculo. Aprende a leer su alma, respetar su ritmo y crear una base espiritual sólida.', age_range: '0-2', age_label: '0 a 2 años', color: '#8A9A72', icon: '👶', order_num: 2, lessons_count: 5, audiobook_url: null },
    { id: 3, title: 'Despertar de la Infancia', subtitle: '2 a 7 años · La magia se despierta', description: 'Entre los 2 y 7 años el niño vive en un estado de consciencia expandida donde la magia y la realidad se funden. Es la etapa más espiritual de la vida. Aprende a honrar y acompañar este despertar.', age_range: '2-7', age_label: '2 a 7 años', color: '#C49A3C', icon: '🌱', order_num: 3, lessons_count: 5, audiobook_url: null },
    { id: 4, title: 'Pequeños Magos de Luz', subtitle: '7 a 12 años · Los dones despiertan', description: 'Entre los 7 y 12 años los niños conscientes comienzan a manifestar sus dones espirituales únicos. Es el momento de acompañar su identidad sagrada, sus talentos y su propósito de vida.', age_range: '7-12', age_label: '7 a 12 años', color: '#C4A8C8', icon: '✨', order_num: 4, lessons_count: 5, audiobook_url: null },
    { id: 5, title: 'Adolescentes Nueva Tierra', subtitle: '12 a 17 años · La misión se revela', description: 'Los adolescentes conscientes de hoy son los constructores de la Nueva Tierra. Aprende a acompañar esta etapa transformadora desde la consciencia y el amor.', age_range: '12-17', age_label: '12 a 17 años', color: '#A8714A', icon: '🌟', order_num: 5, lessons_count: 5, audiobook_url: null },
  ];
